#!/usr/bin/env python3
"""
Minimal CLI to call UnstakeV2Test.removeStake(hotkey, netuid, amountTao)
...
def main():
    parser = argparse.ArgumentParser(description="Minimal unstake helper")
    ...
    parser.add_argument("--amount-tao", type=float, required=True, help="Amount of TAO to unstake (e.g., 0.05)")
    ...
    # Załaduj ABI kontraktu z pliku JSON
    ...
    fn = contract.functions.removeStakeAndBurn(hotkey_bytes, args.netuid, amount_rao)
